  ...
  <div class="article-container">
    ...
    <div class="main-wrap">
      ...
      <div class="article-detail" v-else-if="article.title">
        ...
        <!-- 评论区域 -->
        <comment-list :source="article.art_id" @onload-success="totalCommentCount=$event.total_count" :list="commentList" @reply-click="onReplyClick"></comment-list>
        <!-- 评论区域 -->
        ...
        <!-- 底部区域 -->
          <div class="article-bottom">
            ...
            <collect-article v-model="article.is_collected" :article-id="article.art_id" class="btn-item"></collect-article>
            <!-- <van-icon color="#777" name="good-job-o" /> -->
            <like-article v-model="article.attitude" class="btn-item" :article-id="article.art_id"></like-article>
...
export default {
  ...
  data () {
    return {
      ...
      isPostShow: false, // 控制评论弹出层的显示与影藏
      commentList: [], //  评论列表
      isReplyShow: false, // 控制评论回复弹出层显示与影藏
