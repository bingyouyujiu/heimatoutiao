<template>
    <div class="channel-edit">
        ...
        <van-grid :gutter="10" class="my-grid">
            <van-grid-item v-for="(channel,index) in myChannels" class="grid-item" :key="index" @click="onMyChannelClick(channel,index)">
        ...
        <van-grid :gutter="10" class="recommend-grid">
            <van-grid-item v-for="(channel,index) in recommenChannels" icon="plus" class="grid-item" :key="index" @click="onAddChannel(channel)" :text="channel.name" />
        </van-grid>
    </div>
</template>
